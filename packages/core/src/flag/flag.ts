...
export const Flag = {
  ...
  OPENCODE_SERVER_PASSWORD: process.env["TRYAKSH_SERVER_PASSWORD"] ?? process.env["OPENCODE_SERVER_PASSWORD"],
  OPENCODE_SERVER_USERNAME: process.env["TRYAKSH_SERVER_USERNAME"] ?? process.env["OPENCODE_SERVER_USERNAME"],
  ...
  OPENCODE_DB: process.env["TRYAKSH_DB"] ?? process.env["OPENCODE_DB"],
  ...
  get OPENCODE_CONFIG_DIR() {
    return process.env["TRYAKSH_CONFIG_DIR"] ?? process.env["OPENCODE_CONFIG_DIR"]
  },
  get OPENCODE_PURE() {
    return truthy("TRYAKSH_PURE") || truthy("OPENCODE_PURE")
  },
  get OPENCODE_PLUGIN_META_FILE() {
    return process.env["OPENCODE_PLUGIN_META_FILE"]
  },
  get OPENCODE_CLIENT() {
    return process.env["TRYAKSH_CLIENT"] ?? process.env["OPENCODE_CLIENT"] ?? "cli"
  },
}
